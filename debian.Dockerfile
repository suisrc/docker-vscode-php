...
ENV PHP_URL="https://github.com/suisrc/docker-vscode-php/releases/download/php/php-7.4.8.tar.xz" PHP_ASC_URL=""
#ENV PHP_ASC_URL="https://github.com/suisrc/docker-vscode-php/releases/download/php/php-7.4.8.tar.xz.asc"
...
RUN mkdir -p "/etc/s6/apache2" && \
    echo "#!/usr/bin/env sh\nexec apache2-foreground" > /etc/s6/apache2/run && \
    chmod +x /etc/s6/apache2/run && \
    mkdir "/etc/s6/coder" && \
